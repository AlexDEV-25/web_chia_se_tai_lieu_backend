...
class CommentControllerTest {
    ...
    void testCreateMyComment_Success() throws Exception {
        ...
        mockMvc.perform(post("/api/comments").contentType(MediaType.APPLICATION_JSON).with(csrf())
    ...
    void testUpdateMyComment_Success() throws Exception {
        ...
        mockMvc.perform(put("/api/comments/1").contentType(MediaType.APPLICATION_JSON).with(csrf())
