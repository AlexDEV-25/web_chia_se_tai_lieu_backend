...
import com.example.app.controller.ChatController;
...
class ChatControllerTest {
    ...
    void testChat_Success() throws Exception {
        ...
        mockMvc.perform(post("/api/chats").with(csrf()).contentType(MediaType.MULTIPART_FORM_DATA).param("message", "Hello"))
    ...
    void testChat_WithImage_Success() throws Exception {
        ...
        mockMvc.perform(
                        post("/api/chats").with(csrf()).contentType(MediaType.MULTIPART_FORM_DATA).param("message", "What is this image?"))
