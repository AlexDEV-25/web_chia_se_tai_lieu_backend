...
import com.example.app.dto.response.lesson.*;
...
public class LessonService {
    ...
    public void delete(Long id) {
        ...
        LessonEventDTO dto = lessonMapper.lessonToLessonDTO(entity);
        deleteByKey(id);
    ...
    public LessonDetailResponse update(Long id, LessonRequest request) {
        ...
        LessonEventDTO dto = lessonMapper.lessonToLessonDTO(saved);
